...
public sealed class AppController
{
    ...
    private async Task ExecuteFlowAsync(CancellationToken ct)
    {
        ...
        catch (Exception ex)
        {
            ...
            _tray.ShowBalloon("Japanese OCR", "Screen capture failed.", Hardcodet.Wpf.TaskbarNotification.BalloonIcon.Error);
            return;
        }
        ...
        using (frame)
        {
            ...
            catch (Exception ex)
            {
                ...
                _tray.ShowBalloon("Japanese OCR", $"OCR error: {ex.Message}", Hardcodet.Wpf.TaskbarNotification.BalloonIcon.Error);
                return;
            }
